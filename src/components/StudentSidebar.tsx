...
import { sidebarLinks, isSidebarParent } from "@/config/sidebarLinks";
...
export const StudentSidebar = () => {
  ...
  const menuItems = sidebarLinks.STUDENT;
  console.log('StudentSidebar: menuItems', menuItems);

  console.log('StudentSidebar: rendering');

  if (!menuItems || !Array.isArray(menuItems)) {
    return (
      <div className="bg-slate-800 text-white h-screen fixed left-0 top-0 w-64 flex flex-col z-50">
        <div className="p-4">
          <span className="font-bold text-lg text-red-500">STUDENT SIDEBAR - NO MENU</span>
        </div>
      </div>
    );
  }
  ...
  return (
    ...
    >
      <div className="p-4">
        <span className="font-bold text-lg text-red-500">STUDENT SIDEBAR</span>
      </div>
      {/* Header */}
