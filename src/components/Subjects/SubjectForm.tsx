...
import { subjectService, Subject, CreateSubjectRequest, UpdateSubjectRequest } from '../../services/subjectApi';
...
export const SubjectForm: React.FC<SubjectFormProps> = ({ subject, onClose, onSave }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (isEdit && subject) {
        ...
        result = await subjectService.updateSubject(subject.id, updateData);
