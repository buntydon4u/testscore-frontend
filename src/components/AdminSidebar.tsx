...
import { adminLinks, SidebarLink, isSidebarParent } from "@/config/sidebarLinks";
import { LogOut, ChevronLeft, ChevronRight, GraduationCap, ChevronDown } from 'lucide-react';
