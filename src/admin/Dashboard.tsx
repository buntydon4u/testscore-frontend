import { Users, BookOpen, BarChart3, TrendingUp, FileText, Calendar } from "lucide-react";
import { Layout } from "@/components/Layout";

export const Dashboard = () => {
  const stats = [
    { title: "Total Students", value: "2,543", icon: Users, color: "bg-blue-500" },
    { title: "Active Courses", value: "125", icon: BookOpen, color: "bg-emerald-500" },
    { title: "Completed Exams", value: "4,892", icon: FileText, color: "bg-purple-500" },
    { title: "Success Rate", value: "87%", icon: TrendingUp, color: "bg-orange-500" },
  ];

  const recentExams = [
    { name: "Mathematics Final", date: "2024-01-15", students: 245, status: "Active" },
    { name: "Physics Midterm", date: "2024-01-18", students: 198, status: "Scheduled" },
    { name: "Chemistry Quiz", date: "2024-01-12", students: 320, status: "Completed" },
    { name: "Biology Test", date: "2024-01-20", students: 267, status: "Scheduled" },
  ];
